...
function CodeBlock({ code, copyText }: { code: string; copyText?: string }) {
  return (
    <div className="relative mt-3 rounded-lg border border-border-primary bg-bg-elevated p-4">
      <pre className="overflow-x-auto text-sm text-text-primary font-mono whitespace-pre">
        {code}
      </pre>
      ...
      <div className="mt-8 space-y-4">
        ...
        <div className="rounded-xl border border-border-primary bg-bg-secondary p-6 transition-colors duration-150 hover:border-border-secondary">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-border-primary bg-bg-elevated text-lg">
