...
# Document (with optional filename)
wahooks connections send-document CONNECTION_ID CHAT_ID https://example.com/report.pdf --filename report.pdf

# Video
wahooks connections send-video CONNECTION_ID CHAT_ID https://example.com/clip.mp4

# Audio/voice
wahooks connections send-audio CONNECTION_ID CHAT_ID https://example.com/voice.ogg
```
