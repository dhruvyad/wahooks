...
// Send an image
await client.sendImage(connectionId, chatId, 'https://example.com/photo.jpg', 'Check this out');

// Send a document
await client.sendDocument(connectionId, chatId, 'https://example.com/report.pdf', 'report.pdf');

// Send a video
await client.sendVideo(connectionId, chatId, 'https://example.com/clip.mp4', 'Watch this');

// Send audio
await client.sendAudio(connectionId, chatId, 'https://example.com/voice.ogg');
