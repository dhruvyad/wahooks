...
After creation, the connection will be in `scan_qr` status. Use the [Get QR Code](/api-reference/connections/qr) endpoint to retrieve the QR code for linking your WhatsApp account.
...
```json 201
{
  ...
  "userId": "a80ffc98-6f8b-4f96-a633-f756124c16af",
