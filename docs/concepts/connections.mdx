---
title: Connections
description: "How WhatsApp connections work in WAHooks"
---
...
1. **Create** — a WAHA pod is provisioned and a session is created
2. **QR Scan** — you scan a QR code with WhatsApp to link the account
3. **Working** — the session is active, messages flow in and out
4. **Failed** — the session lost connection (auto-recovered within 1 minute)
5. **Stopped** — you deleted the connection

## Health monitoring

WAHooks polls WAHA sessions every minute:
