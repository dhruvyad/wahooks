...
Every webhook delivery is logged with status, attempt count, and the full payload. Use the [logs endpoint](/api-reference/webhooks/logs) or CLI to inspect deliveries:
